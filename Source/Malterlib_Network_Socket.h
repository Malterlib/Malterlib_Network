...
namespace NMib::NNetwork
{
	...
	public:
		...
		// Makes the close that follows a reset: what is queued for the peer is discarded rather
		// than retransmitted, and the kernel lets go of every page of the zero copy sends at
		// once. For a teardown that must not wait on the peer; a close that should reach the peer
		// intact shuts down and drains first
