...
namespace NMib::NNetwork
{
	...
	namespace
	{
		...
		struct CSSLLowLevel
		{
						...
						[&]() -> decltype(auto)
						{
							...
							CRYPTO_set_mem_functions
								(
									[](size_t _Size) -> void *
									{
										return NMemory::fg_Alloc(_Size);
									}
									, [](void *_pPtr, size_t _Size) -> void *
									{
										return NMemory::fg_Resize(_pPtr, _Size, 0);
									}
									, [](void *_pPtr)
									{
										return NMemory::fg_FreeNoSize(_pPtr);
									}
								)
							;
#endif
			...
			NContainer::TCVector<NStorage::TCIndirection<NMib::NThread::CMutualManyRead>> m_Locks;
			...
			NStorage::TCUniquePointer<NMib::NThread::TCThreadLocal<CThreadLocal>> m_pThreadLocal;
		...
		NStorage::TCAggregate<CSSLLowLevel, 129> g_SSLLowLevel = {DAggregateInit};
	...
	public:
		...
		{
			NContainer::CByteVector CertData = fs_ConvertX509ToBinary(_pCertificate);
		...
		static NStr::CStr fs_GetCertificateInformation(NContainer::CByteVector _CertificateData)
		{
		...
		static NContainer::TCMap<NStr::CStr, NContainer::TCVector<CCertificateExtension>> fs_GetCertificateRequestExtensions(NContainer::CByteVector const &_CertificateRequestData)
		{
			g_SSLLowLevel->f_UseInThread();
		...
		static X509 *fs_LoadCertificate(NContainer::CByteVector const &_CertificateData)
		{
			g_SSLLowLevel->f_UseInThread();
			if (_CertificateData.f_IsEmpty())
		...
		static X509_REQ *fs_LoadCertificateRequest(NContainer::CByteVector const &_CertificateRequestData)
		{
			g_SSLLowLevel->f_UseInThread();
		...
		static NContainer::CByteVector fs_ConvertX509ToBinary(X509 *_pCertificate)
		{
			g_SSLLowLevel->f_UseInThread();
			if (!_pCertificate)
		...
		static NContainer::CByteVector fs_ConvertX509RequestToBinary(X509_REQ *_pCertificateRequest)
		{
			g_SSLLowLevel->f_UseInThread();
		...
		static NContainer::CSecureByteVector fs_ConvertPrivateKeyToDER(EVP_PKEY *_pKey)
		{
			g_SSLLowLevel->f_UseInThread();
			if (!_pKey)
				DMibErrorNetSSL("Key in nullptr");
		...
		static NContainer::CSecureByteVector fs_ConvertPublicKeyToDER(EVP_PKEY *_pKey)
		{
			g_SSLLowLevel->f_UseInThread();
			if (!_pKey)
				DMibErrorNetSSL("Key in nullptr");
		...
		static EVP_PKEY *fs_LoadPrivateKeyFromDER(NContainer::CSecureByteVector const &_Data)
		{
			g_SSLLowLevel->f_UseInThread();
			ERR_clear_error();
		...
		static EVP_PKEY *fs_LoadPublicKeyFromDER(NContainer::CSecureByteVector const &_Data)
		{
			g_SSLLowLevel->f_UseInThread();
			ERR_clear_error();
	...
	NStr::CStr CSSLContext::fs_GetCertificateName(NContainer::CByteVector const &_CertificateData)
	{
		return fg_RunProtectRegisters
			(
				[&]() -> decltype(auto)
	...
	NStr::CStr CSSLContext::fs_GetCertificateDistinguishedName_RFC2253(NContainer::CByteVector const &_CertificateData)
	{
		return fg_RunProtectRegisters
			(
				[&]() -> decltype(auto)
	...
	NStr::CStr CSSLContext::fs_GetCertificateFingerprint(NContainer::CByteVector const &_CertificateData)
	{
		return fg_RunProtectRegisters
			(
				[&]() -> decltype(auto)
	...
	NStr::CStr CSSLContext::fs_GetIssuerName(NContainer::CByteVector const &_CertificateData)
	{
		return fg_RunProtectRegisters
			(
				[&]() -> decltype(auto)
	...
	NContainer::TCVector<NStr::CStr> CSSLContext::fs_GetCertificateHostnames(NContainer::CByteVector const &_CertificateData, bool _bCheckCommonName)
	{
		return fg_RunProtectRegisters
			(
				[&]() -> decltype(auto)
	...
	NContainer::TCMap<NStr::CStr, NContainer::TCVector<CCertificateExtension>> CSSLContext::fs_GetCertificateExtensions(NContainer::CByteVector const &_CertificateData)
	{
		return fg_RunProtectRegisters
			(
				[&]() -> decltype(auto)
	...
	NStr::CStr CSSLContext::fs_GetCertificateHostnamesStr(NContainer::CByteVector const &_CertificateData)
	{
		return fg_RunProtectRegisters
			(
				[&]() -> decltype(auto)
	...
	NTime::CTime CSSLContext::fs_GetCertificateExpirationTime(NContainer::CByteVector const &_CertificateData)
	{
		return fg_RunProtectRegisters
			(
				[&]() -> decltype(auto)
	...
	NStr::CStr CSSLContext::fs_GetCertificateDescription(NContainer::CByteVector const &_CertificateData)
	{
		return fg_RunProtectRegisters
			(
				[&]() -> decltype(auto)
	...
	NStr::CStr CSSLContext::fs_GetCertificateInformation(NContainer::CByteVector const &_CertificateData)
	{
		return fg_RunProtectRegisters
			(
				[&]() -> decltype(auto)
	...
	void CSSLContext::fs_VerifyCertificateRequestSameKeyAsCertificate(NContainer::CByteVector const &_CertRequestData, NContainer::CByteVector const &_CertData)
	{
		fg_RunProtectRegisters
			(
				[&]() -> decltype(auto)
	...
	void CSSLContext::fs_GenerateKeys(NContainer::CSecureByteVector &o_PrivateKeyData, NContainer::CSecureByteVector &o_PublicKeyData, NNetwork::CSSLKeySetting _KeySetting)
	{
		fg_RunProtectRegisters
			(
				[&]() -> decltype(auto)
	...
	public:
		...
		{
			g_SSLLowLevel->f_UseInThread();
			NMemory::fg_MemCopy(_pDataOut, _pDataIn, _Len);
	...
	bool CSSLConnectionResult::f_PeerCertificatesMatchesSpecificCertificate(NContainer::CByteVector const &_SpecificCertificate) const
	{
		...
		NContainer::CByteVector ConvertedCert = CSSLContext::CInternal::fs_ConvertX509ToBinary(pPeerCertificate);
	...
	CEncryptKeyIV::CEncryptKeyIV(NContainer::CSecureByteVector const &_Key, NContainer::CSecureByteVector const &_IV, NNetwork::ESSLCrypto _Crypto)
		: m_Key(_Key)
		, m_IV(_IV)
		, m_Crypto(_Crypto)
	{
	...
	uint32 CEncryptKeyIV::fs_GetKeyLen(NNetwork::ESSLCrypto _Crypto)
	{
		return EVP_CIPHER_key_length(fg_GetCipher(_Crypto));
	}

	uint32 CEncryptKeyIV::fs_GetIVLen(NNetwork::ESSLCrypto _Crypto)
	{
	...
	uint32 CEncryptKeyIV::fs_GetBlockSize(NNetwork::ESSLCrypto _Crypto)
	{
	...
	CEncryptKeyIV CKeyExpansion::f_GetKeyIV(NNetwork::ESSLCrypto _Crypto) const
	{
		EVP_CIPHER const *pCipher = fg_GetCipher(_Crypto);
	...
	{
		CInternal(NNetwork::ESSLCryptoFlags _Flags, CEncryptKeyIV const &_KeyIV)
		{
	...
	CIncrementalEncrypt::CIncrementalEncrypt(NNetwork::ESSLCryptoFlags _Flags, CEncryptKeyIV const &_KeyIV)
	...
	NCryptography::CHashDigest_SHA256 fg_MessageAuthenication_HMAC_SHA256(uint8 const *_pData, mint _DataLen, uint8 const *_pKey, mint _KeyLen)
	{
		...
		{
			DMibErrorNetSSL(NNetwork::fg_GetExceptionStr("Failed to run HMAC-SHA256"));
		}
	...
	NCryptography::CHashDigest_SHA1 fg_MessageAuthenication_HMAC_SHA1(uint8 const *_pData, mint _DataLen, uint8 const *_pKey, mint _KeyLen)
	{
		...
		{
			DMibErrorNetSSL(NNetwork::fg_GetExceptionStr("Failed to run HMAC-SHA1"));
		}
...
{
	NMib::NNetwork::g_SSLLowLevel->f_UseInThread();
}
