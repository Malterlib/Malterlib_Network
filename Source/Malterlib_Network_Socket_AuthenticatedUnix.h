...
namespace NMib::NNetwork
{
	...
	private:
		...
		// Bumped under mp_fOnStateChangeLock (owner thread only) when the object is reused; poller
		// callbacks read it under the lock and drop out when stale
		uint32 mp_ConnectionGeneration = 0;
